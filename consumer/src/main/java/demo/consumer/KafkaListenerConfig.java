...
public class KafkaListenerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Word> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Word> factory =
    ...
    public Deserializer workUnitJsonValueDeserializer() {
        return new JsonDeserializer(Word.class);
    }
}